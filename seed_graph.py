...
GRAPH_NODES = [
    # Industries
    {"name": "roofing", "node_type": "industry", "display_label": "Roofing Contractor"},
    {"name": "trucking", "node_type": "industry", "display_label": "Trucking Company"},
    {"name": "manufacturing", "node_type": "industry", "display_label": "Manufacturing"},
    {"name": "restaurant", "node_type": "industry", "display_label": "Restaurant"},
    {"name": "landscaping", "node_type": "industry", "display_label": "Landscaping Contractor"},
    {"name": "hvac", "node_type": "industry", "display_label": "HVAC Contractor"},

    # Entity types
    {"name": "private_business", "node_type": "entity_type", "display_label": "Private Business"},
    {"name": "public_entity", "node_type": "entity_type", "display_label": "Public Entity"},

    # Public entity subtypes
    {"name": "municipality", "node_type": "public_entity_type", "display_label": "Municipality"},
    {"name": "county", "node_type": "public_entity_type", "display_label": "County"},
    {"name": "school_system", "node_type": "public_entity_type", "display_label": "School System"},
    {"name": "fire_district", "node_type": "public_entity_type", "display_label": "Fire District"},
    {"name": "utility_authority", "node_type": "public_entity_type", "display_label": "Utility Authority"},

    # Departments
    {"name": "law_enforcement", "node_type": "department", "display_label": "Law Enforcement"},
    {"name": "fire_department", "node_type": "department", "display_label": "Fire Department"},
    {"name": "public_works", "node_type": "department", "display_label": "Public Works"},
    {"name": "utilities", "node_type": "department", "display_label": "Utilities"},
    {"name": "parks_recreation", "node_type": "department", "display_label": "Parks & Recreation"},
    {"name": "administration", "node_type": "department", "display_label": "Administration"},
    {"name": "sanitation", "node_type": "department", "display_label": "Sanitation"},
    {"name": "street_maintenance", "node_type": "department", "display_label": "Street Maintenance"},
    {"name": "fleet_services", "node_type": "department", "display_label": "Fleet Services"},
    {"name": "water_treatment", "node_type": "department", "display_label": "Water Treatment"},

    # Private industry risk themes
    {"name": "falls_from_height", "node_type": "risk_theme", "display_label": "Falls from Height"},
    {"name": "fleet_accidents", "node_type": "risk_theme", "display_label": "Fleet/Vehicle Accidents"},
    {"name": "driver_turnover", "node_type": "risk_theme", "display_label": "Driver Turnover"},
    {"name": "subcontractor_transfer", "node_type": "risk_theme", "display_label": "Subcontractor Risk Transfer"},
    {"name": "certificate_tracking", "node_type": "risk_theme", "display_label": "Certificate Tracking Gaps"},
    {"name": "slip_and_fall", "node_type": "risk_theme", "display_label": "Slip and Fall"},
    {"name": "machine_guarding", "node_type": "risk_theme", "display_label": "Machine Guarding"},
    {"name": "combustible_dust", "node_type": "risk_theme", "display_label": "Combustible Dust"},
    {"name": "burns_and_scalds", "node_type": "risk_theme", "display_label": "Burns and Scalds"},
    {"name": "heat_illness", "node_type": "risk_theme", "display_label": "Heat Illness Exposure"},
    {"name": "struck_by_object", "node_type": "risk_theme", "display_label": "Struck-By Object"},
    {"name": "food_contamination", "node_type": "risk_theme", "display_label": "Food Contamination"},
    {"name": "chemical_exposure", "node_type": "risk_theme", "display_label": "Chemical Exposure"},
    {"name": "lifting_ergonomic", "node_type": "risk_theme", "display_label": "Lifting/Ergonomic Injuries"},
    {"name": "improper_classification", "node_type": "risk_theme", "display_label": "Improper Classification"},
    {"name": "hired_non_owned_auto", "node_type": "risk_theme", "display_label": "Hired/Non-Owned Auto"},

    # Public entity risk themes
    {"name": "police_liability", "node_type": "risk_theme", "display_label": "Police Liability"},
    {"name": "civil_rights_claims", "node_type": "risk_theme", "display_label": "Civil Rights Claims (Section 1983)"},
    {"name": "excessive_force", "node_type": "risk_theme", "display_label": "Excessive Force"},
    {"name": "public_officials_liability", "node_type": "risk_theme", "display_label": "Public Officials Liability"},
    {"name": "zoning_decisions", "node_type": "risk_theme", "display_label": "Zoning/Land Use Decisions"},
    {"name": "road_maintenance_liability", "node_type": "risk_theme", "display_label": "Road Maintenance Liability"},
    {"name": "playground_injury", "node_type": "risk_theme", "display_label": "Playground Injury Exposure"},
    {"name": "public_event_liability", "node_type": "risk_theme", "display_label": "Public Event Liability"},
    {"name": "sewer_backup_claims", "node_type": "risk_theme", "display_label": "Sewer Backup Claims"},
    {"name": "water_quality_claims", "node_type": "risk_theme", "display_label": "Water Quality Claims"},
    {"name": "fleet_liability", "node_type": "risk_theme", "display_label": "Municipal Fleet Liability"},
    {"name": "volunteer_liability", "node_type": "risk_theme", "display_label": "Volunteer Liability"},
    {"name": "cyber_records_breach", "node_type": "risk_theme", "display_label": "Cyber/Records Breach"},
    {"name": "grant_compliance", "node_type": "risk_theme", "display_label": "Grant Compliance Risk"},
    {"name": "procurement_disputes", "node_type": "risk_theme", "display_label": "Procurement Disputes"},

    # Coverages
    {"name": "workers_comp", "node_type": "coverage", "display_label": "Workers Compensation"},
    {"name": "general_liability", "node_type": "coverage", "display_label": "General Liability"},
    {"name": "commercial_auto", "node_type": "coverage", "display_label": "Commercial Auto"},
    {"name": "umbrella", "node_type": "coverage", "display_label": "Umbrella/Excess"},
    {"name": "property", "node_type": "coverage", "display_label": "Property"},
    {"name": "builders_risk", "node_type": "coverage", "display_label": "Builders Risk"},
    {"name": "inland_marine", "node_type": "coverage", "display_label": "Inland Marine"},
    {"name": "cyber", "node_type": "coverage", "display_label": "Cyber Liability"},
    {"name": "epli", "node_type": "coverage", "display_label": "EPLI"},
    {"name": "professional_liability", "node_type": "coverage", "display_label": "Professional Liability"},
    {"name": "public_officials_liability_cov", "node_type": "coverage", "display_label": "Public Officials Liability Coverage"},
    {"name": "law_enforcement_liability", "node_type": "coverage", "display_label": "Law Enforcement Liability"},
    {"name": "governmental_immunity", "node_type": "coverage", "display_label": "Governmental Immunity / Tort Claims"},
    {"name": "employment_practices_public", "node_type": "coverage", "display_label": "Employment Practices (Public)"},
    {"name": "municipal_auto", "node_type": "coverage", "display_label": "Municipal Auto"},
    {"name": "environmental_liability_public", "node_type": "coverage", "display_label": "Environmental Liability (Public)"},
]
